...
const SAMPLE_STATE: ResponderMatrixState = {
  ...
  betLines: [
    ...
    { key: 'float_river_stab', label: 'IP Float Stab (C;X-B)' },
  ...
  loading: false,
  error: 'Using sample river responder hand matrix data (API unavailable).',
  usingSample: true,
};
...
export default useRiverResponderHandMatrix;
