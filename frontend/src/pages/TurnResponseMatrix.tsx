      ...
      <Stack spacing={6} maxW="1200px" mx="auto">
        <Stack spacing={3}>
          ...
          <Stack spacing={1} fontSize="sm" color="whiteAlpha.700">
            ...
            <Text>
              • <strong>Double Barrel (B;B)</strong>: the bettor fires both flop and turn streets.
            </Text>
            <Text>
              • <strong>Delayed C-Bet (X;B)</strong>: the preflop aggressor checks the flop and bets the turn when action
              returns.
            </Text>
            <Text>
            ...
            <Text>
              • <strong>XR Barrel (XR;B)</strong>: the bettor check-raises the flop before betting the turn.
            </Text>
            <Text>
              • <strong>Raise Barrel (R;B)</strong>: the bettor raises a flop bet and follows through on the turn.
            </Text>
            <Text>
              • <strong>IP Float Stab (C;X-B)</strong>: an in-position caller stabs the turn after the flop aggressor
              checks.
            </Text>
            <Text>
              • <strong>OOP XC Donk Lead (X-C;B)</strong>: an out-of-position caller leads the turn after check-calling
              the flop.
            </Text>
          </Stack>
        </Stack>
