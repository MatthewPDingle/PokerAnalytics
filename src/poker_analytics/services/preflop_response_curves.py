...
_SAMPLE_SCENARIOS: List[ResponseCurveScenario] = [
    ResponseCurveScenario(
        ...
        points=[
            ...
            _point("pct_100_plus", "100%+", 2.18, 58.8, 32.7, 8.5, 6.0, 9.3, 1.6),
        ],
    ...
    ResponseCurveScenario(
        ...
        points=[
            ...
            _point("pct_100_plus", "100%+", 2.18, 55.8, 28.2, 16.0, 5.4, 13.9, 1.8),
        ],
    ...
    ResponseCurveScenario(
        ...
        points=[
            ...
            _point("pct_100_plus", "100%+", 2.18, 60.3, 31.0, 8.7, 4.0, 13.1, 2.3),
        ],
