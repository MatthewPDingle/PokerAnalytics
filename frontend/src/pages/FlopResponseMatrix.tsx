...
const FlopResponseMatrix = () => {
  ...
  const availablePlayerCounts = useMemo(() => {
    ...
    return sorted;
  }, [data, heroPosition, betType, position, texture, preflopCategory, sprBucket]);
  ...
  }, [data, heroPosition, betType, position, playerCount, texture, preflopCategory, sprBucket]);
  ...
  }, [handData, heroPosition, betType, position, playerCount, texture, preflopCategory, sprBucket]);
  ...
  }, [responderData, heroPosition, betType, position, playerCount, responderResponseType, texture, preflopCategory, sprBucket]);
