"""Tests for hero turn hand matrix aggregation."""

from __future__ import annotations

import unittest

from poker_analytics.services.turn_hand_matrix import _aggregate


class TurnHandMatrixTests(unittest.TestCase):
    def test_aggregate_counts_categories_and_buckets(self) -> None:
        events = [
            ...
            },
            {
                ...
                "is_all_in": False,
                "is_one_bb": False,
                "turn_texture_keys": ["two_tone", "high"],
