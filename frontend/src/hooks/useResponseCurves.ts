...
> = {
  ...
  pct_100_plus: { label: '100%+', ratio: 2.18 },
};
...
const SAMPLE_RESPONSE_CURVES: ResponseCurveScenario[] = [
  {
    ...
    points: [
      ...
      point('pct_100_plus', 58.8, 32.7, 8.5, 6.0, 9.3, 1.6),
    ],
  },
  {
    ...
    points: [
      ...
      point('pct_100_plus', 55.8, 28.2, 16.0, 5.4, 13.9, 1.8),
    ],
  },
  {
    ...
    points: [
      ...
      point('pct_100_plus', 60.3, 31.0, 8.7, 4.0, 13.1, 2.3),
    ],
  },
  {
    ...
    points: [
      ...
      point('pct_100_plus', 56.8, 32.2, 11.0, 3.2, 11.1, 1.8),
    ],
  },
];
